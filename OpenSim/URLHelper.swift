...
struct URLHelper {
    ...
    static let appGroupsComponent = "data/Containers/Shared/AppGroup"
    ...
    static func appGroupsURLForUDID(_ UDID: String) -> URL {
        return deviceURLForUDID(UDID).appendingPathComponent(appGroupsComponent, isDirectory: true)
    }
